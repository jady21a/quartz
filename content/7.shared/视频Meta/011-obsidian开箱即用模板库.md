...
相关代码:[obsidian-workflow-vault](https://github.com/jady21a/obsidian-workflow-vault)
...
> 所以你拿到的不是空壳，也不是一堆要自己拼的零件，而是一个**已经搭好、连好线、能直接跑起来**的库；也可以当参考，照着在自己的库里搭。整套工作流的图文总结见 [[7.shared/专题Meta/001-obsidian工作流总结|工作流总结]]。
