---
title:
  - 009-别再自己列清单了：一个指令，让AI 自动生成你的周复盘
tags:
  - video
videoid: VIDEO_ID
...
<div class="video-player-container" data-youtube="VIDEO_ID" data-bilibili="BILIBILI_ID" data-default-source="youtube" data-title="别再自己列清单了：一个指令，AI 自动生成你的周复盘">
  <lite-youtube videoid="VIDEO_ID" playlabel="别再自己列清单了：一个指令，AI 自动生成你的周复盘"></lite-youtube>
</div>


## 别再自己列清单了：一个指令，让AI 自动生成你的周复盘
...
> 一套**搭一次、用一辈子**的自动复盘系统：你正常记笔记，系统在后台默默存证，每周一句话 `/周复盘`，AI 自动翻完你这一周的所有记录，生成一份真正基于你行为轨迹、只对你一个人成立的复盘。
>
> 全程你不用列清单、不用回忆、不用喂资料。
...
基础数据源是 Obsidian——用它追踪长期项目和每日任务（参见上一篇）。在此之上，只需多做一步：
...
![[CleanShot 2026-05-22 at 15.25.53@2x.png|800]]
