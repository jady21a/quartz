...
**每天上午10点执行:** ``` 0 10 * * * /bin/bash ~/github-push.sh >> ~/cron-test.log 2>&1 ``` **每两天上午10点执行:** ``` 0 10 */2 * * /bin/bash ~/github-push.sh >> ~/cron-test.log 2>&1 ``` **每周四上午10点执行:** ``` 0 10 * * 4 /bin/bash ~/github-push.sh >> ~/cron-test.log 2>&1
