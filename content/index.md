---
title: Welcome to Why Z's home
description: Why Z 的个人知识站——分享 Obsidian 折腾、效率工具、读书与观影笔记。一个真实在用的库,不是空壳模板。
---

我是 **Why Z**,爱折腾工具,也爱把「怎么用 Obsidian 管理知识、项目和生活」拆开讲清楚。
这个站是我**真实在用的库**的公开镜像——每个板块都在自己跑,不是摆样子。

**这里有什么**
- 🛠️ **技术折腾** —— 自研 Obsidian 插件、自动化脚本、踩坑与排障实录
- 📚 [[藏书馆]] / 🎬 [[观影库]] —— 带封面、进度、评分的读书与观影画廊
- 🎥 [[7.shared/视频合集|视频合集]] · [[7.shared/专题合集|专题合集]] —— B站 / YouTube 视频配套的图文教程

**新来的话,从这几篇开始**
>[[7.shared/视频Meta/011-obsidian开箱即用模板库|开箱即用的 Obsidian 模板库]]
>[[7.shared/视频Meta/010-Obsidian homepage|给 Obsidian 做一个像样的主页]]
>[[关于 Why Z|关于我 & 这个站]]
