...
The tutorials and templates from my videos all live here, along with follow-ups there wasn't time to cover in the videos — plus some reading notes and build logs. → [[en/1.Why Z/index|About Why Z]]
## Quick tour

<div class="home-nav-list">
  <a class="home-nav-item" data-no-popover="true" href="/en/videos/video-collection">
    <span class="item-title">Video Collection</span>
    <span class="item-desc">Written tutorials for every video</span>
  </a>
  <a class="home-nav-item" data-no-popover="true" href="/en/videos/topic-collection">
    <span class="item-title">Topic Collection</span>
    <span class="item-desc">Long-form guides organized by theme</span>
  </a>
  <a class="home-nav-item" data-no-popover="true" href="/en/templates/">
    <span class="item-title">Template Library</span>
    <span class="item-desc">All the templates from my videos</span>
  </a>
  <a class="home-nav-item" data-no-popover="true" href="/en/tech-notes/">
...
### More
<div class="home-nav-list">
  <a class="home-nav-item" data-no-popover="true" href="/en/library">
    <span class="item-title">Library</span>
    <span class="item-desc">Books I'm reading and have finished</span>
  </a>
  <a class="home-nav-item" data-no-popover="true" href="/en/watch-list">
